...
class Test_Home_Selection():
    ...
    def test_Home_OC(self):
        ...
        home1 = self.driver.find_element(By.XPATH,"//android.widget.FrameLayout/android.view.ViewGroup/android.widget.TextView[@text = 'Home']")
        ...
        android_widget_imagebutton = self.driver.find_element(By.XPATH,"//android.view.ViewGroup/android.view.ViewGroup/android.widget.ImageButton")
        ...
        ladang_lekir1 = self.driver.find_element(By.XPATH,"//android.widget.LinearLayout/android.view.ViewGroup/android.widget.TextView[@text = 'LADANG LEKIR']")
